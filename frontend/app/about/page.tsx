export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-8">About Fermix</h1>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="text-gray-700 space-y-2">
            <li>• <strong>Orbital Parameters:</strong> Period, duration, depth, impact parameter</li>
            <li>• <strong>Planetary Characteristics:</strong> Radius, temperature, insolation flux</li>
            <li>• <strong>Stellar Properties:</strong> Effective temperature, surface gravity, metallicity</li>
          </ul>
          <p className="text-gray-700 leading-relaxed mt-4">
            Data sourced from the{' '}
            <a href="https://exoplanetarchive.ipac.caltech.edu/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
        ...
        <section className="mb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-blue-600">0.95</div>
                <div className="text-sm text-gray-700">ROC-AUC</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-blue-600">103</div>
                <div className="text-sm text-gray-700">Features</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-blue-600">&lt;50ms</div>
                <div className="text-sm text-gray-700">Latency</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="space-y-2">
            <li>
              <a href="https://github.com/yourusername/fermix" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
                GitHub Repository
              </a>
            </li>
            <li>
              <a href="/api/v1/docs" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
                API Documentation
              </a>
            </li>
            <li>
