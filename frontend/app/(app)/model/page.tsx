export default function ModelPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-8">Model Card</h1>
      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <dt className="font-semibold text-gray-900">Model Type</dt>
                <dd className="text-gray-700">Ensemble (Random Forest + LightGBM)</dd>
              </div>
              <div>
              ...
              <div>
                <dt className="font-semibold text-gray-900">Task</dt>
                <dd className="text-gray-700">Multi-class Classification</dd>
              </div>
              <div>
                <dt className="font-semibold text-gray-900">Classes</dt>
                <dd className="text-gray-700">CONFIRMED, FALSE POSITIVE, CANDIDATE</dd>
              </div>
              <div>
                <dt className="font-semibold text-gray-900">Training Date</dt>
                <dd className="text-gray-700">2025</dd>
              </div>
              <div>
                <dt className="font-semibold text-gray-900">Model Size</dt>
                <dd className="text-gray-700">RF: 5.5MB, LGBM: 1.8MB</dd>
              </div>
            </dl>
          </div>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Training Data</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Models trained on 9,564 observations from the NASA Kepler mission with 103 engineered features.
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li><strong>Source:</strong> NASA Exoplanet Archive (Kepler KOI Table)</li>
            <li><strong>Split:</strong> 80% training, 20% test</li>
            <li><strong>Features:</strong> Orbital parameters, stellar properties, transit characteristics</li>
            <li><strong>Labels:</strong> koi_disposition (CONFIRMED, FALSE POSITIVE, CANDIDATE)</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-700">Recall</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-3">LightGBM</h3>
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-green-600">0.90</div>
                  <div className="text-sm text-gray-700">Precision</div>
                </div>
                <div>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Hyperparameters</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-3">Random Forest</h3>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-3">LightGBM</h3>
              <ul className="text-gray-700 space-y-1 text-sm">
                <li>• num_leaves: 31</li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Intended Use</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
