    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-500/10 border-2 border-blue-400/30 mb-6 transition-all duration-1000 ${mounted ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}>
          ...
          <p className={`text-xl text-white/60 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className={`relative max-w-4xl mx-auto transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-white/10 rounded-2xl p-12 md:p-20 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-400/30 text-blue-400 text-sm font-medium mb-6">
              ...
              <div className="relative aspect-video bg-black/30 rounded-lg border border-white/10 mb-8 overflow-hidden group">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  <p className="text-white/80 font-medium mb-1">Model Demonstrations</p>
                  <p className="text-white/40">Watch AI classify exoplanets in real-time</p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  <p className="text-white/80 font-medium mb-1">Data Visualization</p>
                  <p className="text-white/40">Explore 9,564 Kepler observations</p>
                </div>
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  <p className="text-white/80 font-medium mb-1">Behind the Science</p>
                  <p className="text-white/40">Deep dive into our methodology</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={`text-center mt-12 transition-all duration-1000 delay-500 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
          <p className="text-white/40 text-sm">
            ...
            <a href="/about" className="text-blue-400 hover:text-blue-300 transition-colors underline">
